...
import com.wission.ui.billDetails.BillListActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    FloatingActionButton fltBtnRoomDatabase,fltBtnBillAddRoomDatabase;
    Context context;
    ...
    private void setListners() {
        ...
        fltBtnBillAddRoomDatabase.setOnClickListener(onClickListener);
    }
    ...
    private View.OnClickListener onClickListener = (view) -> {
        switch (view.getId()) {
            ...
            case R.id.fltBtnRoomDatabase:
                //Todo: Using RoomDatabase task(insert , update,delete user details)
                startActivity(new Intent(MainActivity.this, UserList_RoomActivity.class));
                break;

            case R.id.fltBtnBillAddRoomDatabase:
                //Todo: Using RoomDatabase billing task(Model with list of data insert, update,delete bill customer details,customer medicine list)
            ...
            btnSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (userName.isEmpty()){
                        ...
                        //Todo: add user details in database using viewmodel class
    ...
    private void getIds() {
        ...
        fltBtnBillAddRoomDatabase = findViewById(R.id.fltBtnBillAddRoomDatabase);
    }
